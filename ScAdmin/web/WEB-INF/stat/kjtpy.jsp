                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="<%=ctxPath%>/Stat?action=typeStat&type=kjtpy"><i class="fa fa-circle-o text-gray"></i> 科技特派员</a></li>
                                    ...
                                    <div class="box-body">
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <th>${cityTotal.skjtpy}</th>
                                                <th>${cityTotal.ckjtpy}</th>
                                                <th>${cityTotal.xkjtpy}</th>
                                            </tr>
...
<script>
    ...
    $(function () {
        ...
        var barChartData                     = [
            {
                value    : ${cityTotal.skjtpy},
                color    : '#f56954',
                highlight: '#f56954',
                label    : '省科技特派员'
            },
            {
                value    : ${cityTotal.ckjtpy},
                color    : '#00a65a',
                highlight: '#00a65a',
                label    : '市科技特派员'
            },
            {
                value    : ${cityTotal.xkjtpy},
                color    : '#00c0ef',
                highlight: '#00c0ef',
                label    : '县科技特派员'
            },
