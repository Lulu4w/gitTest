...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页<span class="c-gray en">&gt;</span> 统计分析 <span class="c-gray en">&gt;</span> 情系毕节人才回归<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<div id="report1" style="display: none;" >人才类型:<table class="table table-border table-bordered table-hover table-bg">
    ...
    <tr class="text-c">
        <td>回乡创业人才(人)</td>
        <td>${cityTotalD.hxcy}</td>
    </tr>
    <tr class="text-c">
        <td>回乡创业项目(个)</td>
        <td>${cityTotalD.hxcyproject}</td>
    </tr >
    </tbody>
</table></div>
...
<script type="text/javascript">
    ...
    $(function () {
        $('#container').highcharts({
            ...
            series: [{
                name: '回乡创业人才(人)',
                data: [${cityTotalD.hxcy}]

            },{
                name: '回乡创业项目数(个)',
                data: [${cityTotalD.hxcyproject}]
