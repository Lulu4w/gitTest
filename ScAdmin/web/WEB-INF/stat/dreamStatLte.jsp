            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview active">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="<%=ctxPath%>/Stat?action=dreamStat"><i class="fa fa-circle-o text-red"></i> 圆梦小康专家行动</a></li>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-header">
                            <div class="box-header with-border">
                                <h3 class="box-title">圆梦小康专家行动</h3>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="with-border">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div style="height: 20px;width: 20px; background-color: #c1c7d1;float: left"></div>
                                                <label>&nbsp;&nbsp;&nbsp;重点学科、重点产业人才团队(人)</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-2">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div style="height: 20px;width: 20px; background-color: #21ba4b;float: left"></div>
                                                <label>&nbsp;&nbsp;&nbsp;医院(个)</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div style="height: 20px;width: 20px; background-color: #bab161;float: left"></div>
                                                <label>&nbsp;&nbsp;&nbsp;学校(个)</label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="box-body">
                                        <table class="table table-bordered">
                                            <tr>
                                                <th width="25%">重点学科、重点产业人才团队(人)</th>
                                                <th width="25%">专家服务团(人)</th>
                                                <th width="25%">医院(个)</th>
                                                <th width="25%">学校(个)</th>
                                            </tr>
                                            <tr>
                                                <th>${cityTotalD.rctd}</th>
                                                <th>${cityTotalD.zjfwt}</th>
                                                <th>${cityTotalD.hospital}</th>
                                                <th>${cityTotalD.school}</th>
                                            </tr>
                                        </table>
                                    </div>
                                    <!-- /.box-body -->
    ...
    $(function () {
        ...
        var barChartData                     = {
            ...
            datasets: [
                ...
                {
                    label               : '医院(个)',
                    fillColor           : 'rgba(60,188,100,0.9)',
                    strokeColor         : 'rgba(60,188,100,0.8)',
                    pointColor          : '#3aba60',
                    pointStrokeColor    : '#21ba4b',
                    pointHighlightFill  : '#fff',
                    pointHighlightStroke: 'rgba(60,188,100,1)',
                    data                : [
                        ${cityTotalD.hospital},
                    ]
                },
                {
                    label               : '学校(个)',
                    fillColor           : 'rgba(178,186,72,0.9)',
                    strokeColor         : 'rgba(178,186,72,0.8)',
                    pointColor          : '#bab26c',
                    pointStrokeColor    : '#bab161',
                    pointHighlightFill  : '#fff',
                    pointHighlightStroke: 'rgba(178,186,72,1)',
                    data                : [
                        ${cityTotalD.school},
                    ]
                }
