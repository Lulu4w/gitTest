                ...
                <li class="treeview active">
                  ...
                  <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="<%=ctxPath%>/Stat?action=proStat"><i class="fa fa-circle-o text-green"></i> 专家组成员</a></li>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="box-body">
                                        <table class="table table-bordered">
                                            <tr>
                                                <th></th>
                                                <c:forEach items="${zjz}" var="zj" begin="1">
                                                    <th>${zj.typename}</th>
                                                </c:forEach>
                                            </tr>
                                            <tr>
