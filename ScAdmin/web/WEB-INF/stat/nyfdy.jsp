                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="<%=ctxPath%>/Stat?action=typeStat&type=nyfdy"><i class="fa fa-circle-o text-aqua"></i> 农业辅导员</a></li>
                                    ...
                                    <div class="box-body">
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <th>${cityTotal.snyfdy}</th>
                                                <th>${cityTotal.cnyfdy}</th>
                                                <th>${cityTotal.xnyfdy}</th>
                                            </tr>
...
<script>
    ...
    $(function () {
        ...
        var barChartData                     = [
            {
                value    : ${cityTotal.snyfdy},
                color    : '#f56954',
                highlight: '#f56954',
                label    : '省科技副职'
            },
            {
                value    : ${cityTotal.cnyfdy},
                color    : '#00a65a',
                highlight: '#00a65a',
                label    : '市科技副职'
            },
            {
                value    : ${cityTotal.xnyfdy},
                color    : '#00c0ef',
                highlight: '#00c0ef',
                label    : '县科技副职'
            },
